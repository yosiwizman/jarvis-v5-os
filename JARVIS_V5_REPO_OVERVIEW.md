...
- **Version tags** (like `v5.0.0`, `v5.0.1`, `v5.1.0`) are **frozen restore points**.
...
2. **Decide the version number**:
   - **Patch release** (bug fixes, small tweaks): `v5.0.1`, `v5.0.2`
   - **Minor release** (new features, backwards-compatible): `v5.1.0`, `v5.2.0`
