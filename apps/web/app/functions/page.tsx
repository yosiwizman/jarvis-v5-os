...
export default function FunctionsPage() {
  ...
  const {
    isFunctionEnabled,
    toggleFunction: toggleFunctionEnabled,
    enableAll,
    disableAll,
  } = useFunctionSettings();
    ...
    <div className="space-y-6">
      ...
      <header className="space-y-2">
        ...
        <p className="text-white/70">
          Complete documentation of all functions available to{" "}
          {BRAND.productName} AI Assistant
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="card p-6">
          <div className="text-4xl font-bold akior-accent-text">
            {jarvisFunctions.length}
          </div>
            ...
            >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="text-xl font-mono akior-accent-text">
                        {func.name}
                      </h3>
                      <span className="text-xs px-2 py-1 bg-[color:rgb(var(--akior-accent)_/_0.2)] akior-accent-text rounded">
                        {func.parameters.required.length > 0
                          ? "Required Params"
                          : "Optional Params"}
                      </span>
              ...
              {isExpanded && (
                <div className="px-6 pb-6 space-y-6 border-t border-white/10 pt-6">
                  {/* Parameters */}
                  <div>
                    <h4 className="text-lg font-semibold mb-3 akior-accent-text">
                      📋 Parameters
                    </h4>
                        ...
                        ([paramName, paramDef]: [string, any]) => (
                          ...
                          >
                            <div className="flex items-start justify-between mb-2">
                              <code className="text-sm font-mono akior-accent-text">
                                {paramName}
                              </code>
                              <div className="flex gap-2">
                                {func.parameters.required.includes(
                                  paramName,
                                ) && (
                                ...
                                <span className="text-xs px-2 py-1 bg-[color:rgb(var(--akior-accent)_/_0.2)] akior-accent-text rounded font-mono">
                  ...
                  {/* Usage Notes */}
                  <div className="bg-[color:rgb(var(--akior-accent)_/_0.1)] rounded-lg p-4 border border-[color:rgb(var(--akior-accent)_/_0.2)]">
                    <h4 className="text-sm font-semibold mb-2 akior-accent-text">
                      💡 Usage Notes
                    </h4>
                    <ul className="text-sm text-white/70 space-y-1 list-disc list-inside">
                      {func.name === "search_files" && (
                        <>
                          <li>
                            Always use this BEFORE open_file when user asks to
                            open a file
                          </li>
                          <li>
                            Returns a list of matching files to choose from
                          </li>
                      ...
                      {func.name === "open_file" && (
                        <>
                          <li>
                            Use AFTER search_files to get the exact filename
                          </li>
                          <li>
                            Automatically renders 3D models (.glb, .obj, .stl)
                            with Three.js
                          </li>
                      ...
                      {func.name === "create_image" && (
                        <>
                          ...
                          <li>
                            Choose size based on content: portrait (1024x1792),
                            landscape (1792x1024), or square (1024x1024)
                          </li>
                      ...
                      {func.name === "navigate_to_page" && (
                        <>
                          <li>
                            Instantly navigates to any page in the application
                          </li>
                          <li>
                            Available pages: menu, voice, 3D tools, files, chat,
                      ...
                      {func.name === "capture_images" && (
                        <>
                          <li>
                            Captures from all connected cameras simultaneously
                          </li>
                          <li>
                            Optional tag parameter for organizing captures
                          </li>
                        </>
                      )}
                      {func.name === "analyze_camera_view" && (
                        <>
                          ...
                          <li>
                            Great for identifying objects, reading text,
                            describing scenes
                          </li>
                        </>
                      )}
      ...
      <section className="card p-6 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border-cyan-500/20">
        ...
        <div className="space-y-3 text-white/70">
          <p>
            AKIOR uses OpenAI's function calling feature to intelligently
            determine which function to execute based on your natural language
            request. Simply ask AKIOR what you want in plain English, and it
            will automatically:
          </p>
          <ol className="list-decimal list-inside space-y-2 ml-4">
            ...
            <li>
              Show you the results in the best format (visual, text, or
              interactive)
            </li>
          </ol>
          <div className="mt-4 p-4 bg-black/30 rounded-lg border border-cyan-500/30">
            ...
            <p className="text-sm">
              You can chain multiple functions together! For example: "Search
              for hammer files and open the first one" will automatically call
              search_files, then open_file with the best match.
            </p>
          </div>
        </div>
      </section>
