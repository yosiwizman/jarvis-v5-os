              ...
              {!isLoginPage && !isJarvisPage && (
                ...
                >
                  ...
                  <nav className="space-y-2 flex-1">
                    ...
                    <Link
                      className={`block btn truncate ${pathname === "/settings/channels" ? "bg-[color:rgb(var(--akior-accent)_/_0.15)] border-l-2 border-l-[color:rgb(var(--akior-accent))] akior-accent-text" : ""}`}
