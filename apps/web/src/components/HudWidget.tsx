...
export function HudWidget() {
  ...
  useEffect(() => {
    try {
      const stored = window.localStorage.getItem("akior-hud-collapsed");
      if (stored !== null) {
  ...
  const toggleCollapsed = () => {
    ...
    try {
      window.localStorage.setItem("akior-hud-collapsed", String(newState));
    } catch {
      // ignore
    }
  };
  ...
  const isHealthy =
    systemStatus.level === "healthy" || systemStatus.level === "standalone";
  const needsAttention =
    systemStatus.level === "setup_required" ||
  ...
  return (
    <div className="fixed right-6 top-6 z-[70] pointer-events-auto">
      <div className="flex items-start gap-2">
        ...
        >
          <div className="bg-[rgba(var(--akior-panel-surface),0.3)] backdrop-blur-md border border-[rgba(var(--akior-accent),0.2)] rounded-lg p-4 shadow-lg">
            {/* Header: Date, Status, and Notifications Bell */}
            <div className="flex justify-between items-center mb-3">
              <div
                className="text-sm"
                style={{ color: `rgba(var(--akior-accent), 0.8)` }}
              >
                {formattedDate}
              </div>
            ...
            {/* Time Display */}
            <div
              className="text-3xl text-white tracking-wide text-center mb-1"
            ...
            <div
              ...
              style={{ backgroundColor: `rgba(var(--akior-accent), 0.1)` }}
            ></div>
            ...
            <div className="space-y-3">
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  <span style={{ color: `rgba(var(--akior-accent), 0.6)` }}>
                    CPU LOAD
                  </span>
                  <span style={{ color: `rgba(var(--akior-accent), 0.9)` }}>
                ...
                >
                  <div
                    ...
                    style={{
                      width: `${cpuLoad}%`,
                      backgroundColor: `rgba(var(--akior-accent), 0.5)`,
                    }}
                  ></div>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  <div
                    ...
                    style={{
                      width: `${memoryUsedPct}%`,
                      backgroundColor: `rgba(var(--akior-accent-muted), 0.5)`,
                    }}
                  ></div>
                </div>
              </div>
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: `rgba(var(--akior-glow), 0.5)`,
                    }}
                  ></div>
                </div>
              </div>
