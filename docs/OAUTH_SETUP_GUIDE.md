...
Complete guide for configuring Google OAuth2 integrations in AKIOR
...
6. [AKIOR Configuration](#akior-configuration)
...
AKIOR integrates with Gmail and Google Calendar using **OAuth2 Refresh Token flow**. This guide walks you through:

- Creating a Google Cloud project
- Generating OAuth2 credentials
- Obtaining refresh tokens
- Configuring AKIOR with your credentials
...
- ✅ AKIOR server running locally
- ✅ Node.js 18+ installed
- ✅ Administrator access to your AKIOR installation
...
3. Enter project details:
   - **Project Name:** `AKIOR Integration` (or any name)
...
7. **Sign in with Google:**
   ...
   - Click **Advanced** → **Go to AKIOR (unsafe)** (this is safe, it's your app)
...
1. Locate your AKIOR settings file:
   - Path: `data/settings.json` (in AKIOR root directory)
...
**Access Token:**
- Valid for 1 hour
- Automatically refreshed by AKIOR clients
- Not stored (regenerated as needed)

### Token Refresh Flow

AKIOR automatically handles token refresh:
...
2. Review GitHub Issues: [AKIOR Issues](https://github.com/your-repo/issues)
...
**Congratulations!** Your AKIOR Gmail and Google Calendar integration is now fully configured! 🎉
